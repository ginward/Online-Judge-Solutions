 ...
 * Solution to https://www.hackerrank.com/challenges/pacman-ucs
 */
public class PacMan_UCS {
    public static void main(String[] args) {
        ...
        while((str = scanner.nextLine())!=null){
            ...
            //solve the game
            UCS_Search(map, pac_x, pac_y, food_x, food_y, dimension_x, dimension_y);
        }
    }
    public static void UCS_Search(char[][]map, int pac_x, int pac_y, int food_x, int food_y, int dimension_x, int dimension_y){
