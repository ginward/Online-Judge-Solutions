...
/**
 * Created by jinhuawang on 7/2/16.
 * Solution to https://www.hackerrank.com/challenges/pacman-dfs
 */
public class PacMan_DFS {
    ...
    public static void DFS_Search(char[][]map, int pac_x, int pac_y, int food_x, int food_y, int dimension_x, int dimension_y){
        ...
        Stack<Vertex_PAC> neighbors=new Stack<>();
        ...
        while(!neighbors.isEmpty()){
            Vertex_PAC vertex = neighbors.pop();
            explored.add(vertex);
            count++;
